...
export default function SignUpStep2({ setSignUpStep }: Props) {
  ...
  return (
    <form className="pb-6">
      <div className="flex flex-col gap-4 mb-6">
        <Field>
          <FieldLabel htmlFor="input-sign-up-name">이름</FieldLabel>
      ...
      <button type="button" className="bg-[#1E1B4B] text-white text-sm w-full h-10 rounded-md" onClick={() => setSignUpStep(3)}>
        가입하기
      </button>
    </form>
  );
